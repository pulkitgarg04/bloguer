              ...
              <div className="w-full flex-col justify-center items-start gap-8 flex">
                <div className="w-full flex-col justify-start lg:items-start items-center gap-3 flex">
                  ...
                  <p className="text-gray-500 text-base font-normal leading-relaxed lg:text-start text-center">
                    <b>Bloguer</b> is more than just a platform; it's a community
                    where creativity meets purpose. Our journey is about enabling 
                    storytellers, thinkers, and dreamers to share their perspectives 
                    with the world, making blogging effortless and impactful for all.
                  </p>
                </div>
